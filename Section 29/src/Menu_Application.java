...
class MyFrame15 extends Frame
{
    ...
    public MyFrame15()
    {
        ...
        open.addActionListener((ActionEvent ae)->tf.setText("Open")); // Using Lambda Expressions.
...
public class Menu_Application {
    public static void main(String[] args) {
        MyFrame15 mf15 = new MyFrame15();
        mf15.setLayout(new FlowLayout());
        mf15.setSize(500,500);
